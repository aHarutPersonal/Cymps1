...
class AscentMap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Reverse the list so index 0 is at the bottom (Start)
    // Actually, ListView with reverse:true handles scrolling from bottom.
    // But logically, week 1 is at the bottom.
    // If we pass weeks [1, 2, 3...], week 1 is index 0.
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final week = weeks[index]; // With reverse:true, index 0 is Week 1? No, index 0 is first in 'weeks' list.
        ...
        // 3 -> Left
        // 4 -> Center
        final double xOffset = sin(index * pi / 2) * 0.4; // 0.4 is 40% of screen width offset
        ...
        final double nextXOffset = hasNext ? sin((index + 1) * pi / 2) * 0.4 : 0;
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
            ...
            Positioned.fill(
              child: CustomPaint(
                painter: _PathPainter(
                  ...
                  color: (week['isCompleted'] == true || week['isCurrent'] == true) 
                      ? AppColors.primary 
          ...
          // Node
          Align(
            alignment: Alignment(xOffset * 2, 0), // alignment x is -1 to 1. xOffset is 0.4, so 0.8
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: isCurrent 
              ...
              : (isCompleted ? null : Border.all(color: AppColors.border, width: 2)),
          boxShadow: isCurrent 
              ? AppShadows.glowLime
              : (isCompleted ? [
                  BoxShadow(
          ...
          child: isCompleted && !isCurrent
              ...
              : Text(
                  ...
                  style: AppTypography.h3.copyWith(
                    color: isCurrent 
                        ? AppColors.primary 
                        : (isCompleted ? AppColors.bg : AppColors.textSecondary),
...
class _PathPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double startX = (size.width / 2) + (startOffset * size.width / 2 * 2); 
