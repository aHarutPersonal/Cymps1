...
Key insight: Consistency beats intensity. Small daily actions compound over time.`,
  attachments: ['idol', 'plan', 'achievement'] as AttachmentType[],
};

export function EditNoteScreen({ onBack, onSave, initialData = mockInitialData }: EditNoteScreenProps) {
  ...
  return (
    <div className="h-screen bg-[#121212] flex flex-col">
      ...
      >
        ...
        <h1 className="text-white text-2xl">Edit note</h1>
      </motion.div>
