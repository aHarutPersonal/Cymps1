...
def downgrade() -> None:
    ...
    sa.Enum(name='plan_item_status').drop(op.get_bind(), checkfirst=True)
    sa.Enum(name='plan_item_type').drop(op.get_bind(), checkfirst=True)
    ...
    sa.Enum(name='user_achievement_category').drop(op.get_bind(), checkfirst=True)
