...
## 2024-05-18 - Defer related data fetching until after pagination
**Learning:** Fetching related DB records (like user interactions) before pagination causes unnecessary DB load and larger query sizes for items that will be discarded.
**Action:** Always paginate the primary list of items first before making secondary DB queries to fetch related data for those items.
